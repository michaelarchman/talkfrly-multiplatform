...
interface StreamRepository {
    ...
    suspend fun updateStream(id: String, streamRequest: StreamRequest): DataResult<StreamResponse, DataError.Remote>
...
class StreamRepositoryImpl(
    ...
    override suspend fun streamList(page: Int, limit: Int): DataResult<StreamList, DataError.Remote> {
        return api
